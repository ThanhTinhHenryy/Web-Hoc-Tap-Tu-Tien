      ...
      <div className="w-full max-w-6xl px-6 py-8 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-200 mt-4 max-w-3xl mx-auto">
            Harness your inner energy and strengthen your spiritual core
          </p>
        </div>

        {selectedExercise ? (
          <div className="bg-gray-900/80 rounded-xl p-8 shadow-2xl border border-blue-500/30">
            ...
            <div className="flex justify-between mt-8">
              ...
              <button className="bg-gradient-to-r from-blue-700 to-blue-600 text-white font-bold py-3 px-8 rounded-lg shadow-lg hover:shadow-blue-600/50 hover:scale-105 transition-all duration-300 border-2 border-blue-500 flex items-center">
                <span className="text-lg">Start Energy Training</span>
          ...
          <>
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="bg-blue-700/80 text-white text-xs px-2 py-1 rounded-full">
                        {exercise.difficulty}
                      </span>
                    </div>
            ...
            <div className="flex justify-between mt-16">
              <Link
                to="/tu-luyen/huan-luyen/mental"
                className="bg-gradient-to-r from-purple-700 to-purple-600 text-yellow-100 font-bold py-3 px-8 rounded-lg shadow-lg hover:shadow-purple-600/50 hover:scale-105 transition-all duration-300 border-2 border-purple-500 flex items-center"
              >
                <span className="mr-2 text-xl">🧠</span>
                <span className="text-lg">Mental Training</span>
              </Link>
              <Link
                to="/tu-luyen/huan-luyen/physical"
              ...
              >
                <span className="text-lg">Physical Training</span>
                <span className="ml-2 text-xl">💪</span>
              </Link>
            </div>
          </>
